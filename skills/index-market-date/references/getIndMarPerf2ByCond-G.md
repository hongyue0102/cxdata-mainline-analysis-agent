# 债券指数市场表现-通用 (getIndMarPerf2ByCond-G)

**API_ID:** getIndMarPerf2ByCond-G
...
| indCode | 债券指数代码 | 字符类型 | 否 |  |
| indShortName | 债券指数简称 | 字符类型 | 否 |  |
...
| IND_CODE | 债券指数代码 | 字符类型 |
| IND_SHORT_NAME | 债券指数简称 | 字符类型 |
